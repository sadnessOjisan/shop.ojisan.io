    ...
    <Layout>
      <div className={aboutPageStyles.wrapper}>
        ...
        <p className={aboutPageStyles.text}>
          ...
          に在庫を補充・更新したらHPが更新されるJAMStackサイトを作りました。ただ実装の都合で決済は実装していないため、購入申し込み時にFormに登録するメールアドレス、もしくはTwitterDMでのやりとりにて決済・配送をします。
        </p>
        ...
        <p className={aboutPageStyles.text}>
          申し込みが済んだら、その後の決済方法・受け渡し方法をメールもしくはTwitterDMにて行います。申し込みが済んだ段階で「商談中」ステータスとして扱います。
        </p>
        <p className={aboutPageStyles.text}>
